...
namespace ICS
{
    public partial class particular_products1 : Form
    {
        public particular_products1()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlDataAdapter da = new SqlDataAdapter("select * from PRODUCT where PRODID = '" + textBox1.Text + "'", con);
