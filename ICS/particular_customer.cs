...
namespace ICS
{
    public partial class particular_customer : Form
    {
        public particular_customer()
        {
            InitializeComponent();
        }

        private void particular_customer_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlDataAdapter da = new SqlDataAdapter("select * from CUSTABLE where CUSCODE = '" + textBox1.Text + "'", con);
