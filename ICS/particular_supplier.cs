...
namespace ICS
{
    public partial class particular_supplier : Form
    {
        public particular_supplier()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlDataAdapter da = new SqlDataAdapter("select * from SUPPTABLE where SUPPCODE = '" + textBox1.Text + "'", con);
