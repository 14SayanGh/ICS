...
namespace ICS
{
    public partial class particular_product : Form
    {
        public particular_product()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlDataAdapter da = new SqlDataAdapter("select * from PRODUCT where PRODNAME = '" + textBox1.Text + "'", con);
