...
namespace ICS
{
    public partial class particular_sales2 : Form
    {
        public particular_sales2()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlDataAdapter da = new SqlDataAdapter("select * from SALETABLE where COMPANY = '" + textBox1.Text + "'", con);
                DataSet ds = new DataSet();
                da.Fill(ds, "a1");
                textBox1.Text = ds.Tables["a1"].Rows[0][5].ToString();
                ...
                textBox5.Text = ds.Tables["a1"].Rows[0][2].ToString();
                textBox6.Text = ds.Tables["a1"].Rows[0][4].ToString();
