...
namespace ICS
{
    public partial class particular_purchase3 : Form
    {
        public particular_purchase3()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlDataAdapter da = new SqlDataAdapter("select * from PURCHTABLE where COMPANY = '" + textBox1.Text + "'", con);
