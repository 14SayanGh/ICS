...
namespace ICS
{
    public partial class particular_purchase1 : Form
    {
        public particular_purchase1()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlDataAdapter da = new SqlDataAdapter("select * from PURCHTABLE where PRODID = '" + textBox1.Text + "'", con);
