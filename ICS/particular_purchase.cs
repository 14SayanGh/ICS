...
namespace ICS
{
    public partial class particular_purchase : Form
    {
        public particular_purchase()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlDataAdapter da = new SqlDataAdapter("select * from PURCHTABLE where VOUCHERNO = '" + textBox1.Text + "'", con);
